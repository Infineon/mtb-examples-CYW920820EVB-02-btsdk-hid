...
{
    WICED_BT_TRACE("\nCHAR_CTL:0x%02X->",cmd);
    ANDROID_voice_send_notification(hidd_blelink.gatts_conn_id, HANDLE_ATV_VOICE_CTL_CHARACTERISTIC_VALUE, 1, &cmd, WICED_FALSE);
}
...
{
//    WICED_BT_TRACE("\nCHAR_RX:%d->",len);
    ANDROID_voice_send_notification(hidd_blelink.gatts_conn_id, HANDLE_ATV_VOICE_RX_CHARACTERISTIC_VALUE, len, ptr, WICED_FALSE);
}
